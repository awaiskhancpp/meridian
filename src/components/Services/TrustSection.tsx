    ...
    <section aria-labelledby="trust-section-heading" className="py-10 lg:py-16 mt-10 lg:mt-16">
      <Container>
        ...
        <h2 id="trust-section-heading" className="mt-4 text-center">
          <span className="block text-[clamp(2.2rem,5.4vw,3.8rem)] font-black uppercase leading-[0.98] tracking-heading-subtle text-dark">
            {heading}
          </span>
        ...
        <div className="mt-12 grid grid-cols-1 gap-6 lg:grid-cols-2">
          <div className="flex flex-col items-center gap-8 p-8">
            ...
            <div className="mt-auto grid w-full grid-cols-2 items-center gap-8 divide-x divide-divider pt-4">
              {/* Google rating */}
              <div className="flex flex-col items-center text-center">
                <svg viewBox="0 0 24 24" className="h-6 w-6" aria-hidden="true">
                  ...
                  <path
                    ...
                    fill="var(--color-decorative-green)"
                  />
                  <path
                    d="M5.84 14.09c-.22-.66-.35-1.36-.35-2.09s.13-1.43.35-2.09V7.07H2.18C1.43 8.55 1 10.22 1 12s.43 3.45 1.18 4.93l2.85-2.22.81-.62z"
                    fill="var(--color-decorative-gold)"
                  />
                  <path
                    d="M12 5.38c1.62 0 3.06.56 4.21 1.64l3.15-3.15C17.45 2.09 14.97 1 12 1 7.7 1 3.99 3.47 2.18 7.07l3.66 2.84c.87-2.6 3.3-4.53 6.16-4.53z"
                    fill="var(--color-decorative-red)"
                  />
                </svg>
          ...
          <div className="relative min-h-[18rem] w-full overflow-hidden border border-muted lg:min-h-0">
