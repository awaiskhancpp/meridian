 ...
 * BeforeAfterSlider
 *
 * A single draggable comparison widget Ã¢â‚¬â€ one "after" photo underneath,
 ...
 * the cursor momentarily leaves the image bounds Ã¢â‚¬â€ without it, moving
 ...
 * with ArrowLeft/ArrowRight nudging the position Ã¢â‚¬â€ not just a
...
export default function BeforeAfterSlider({
  ...
  return (
    ...
    >
      {/* After Ã¢â‚¬â€ full image, underneath */}
      ...
      {/* Divider line */}
      <div
        className="pointer-events-none absolute inset-y-0 w-divider -translate-x-1/2 bg-section"
        style={{ left: `${position}%` }}
      />
      ...
      <div
        ...
        className="absolute top-1/2 flex h-10 w-10 -translate-x-1/2 -translate-y-1/2 cursor-ew-resize items-center justify-center rounded-full bg-section text-dark shadow-card outline-none focus-visible:ring-2 focus-visible:ring-accent"
        style={{ left: `${position}%` }}
      >
