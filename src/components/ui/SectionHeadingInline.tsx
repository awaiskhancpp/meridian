...
/**
 * SectionHeadingInline â€” Type 2: left-aligned header.
 *
 * Used by About and Services â€” the two sections whose heading sits
 ...
 * mx-auto/text-center/max-width wrapper â€” left alone to size to its
 * parent instead.
 *
